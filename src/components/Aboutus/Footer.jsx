    ...
    <section className='footer'>
      <div className='footer-details'>
        ...
        <div className='loc-svg'>
          ...
          <div className='location'>
            <label>Contact</label>
            <span>Email: info@sqladvisory.co</span>
          </div>
        </div>
      ...
      <div className='footer-end'>
        ...
        <div className='quicklinks'>
          ...
          <ul>
            ...
            <Link to='https://drive.google.com/file/d/1-HM2IMvJnFySHzf9blZR1kkBcGIHQ4gB/view?usp=sharing'>
              <li>Privacy Policy</li>
            </Link>

            <Link to='https://drive.google.com/file/d/10xY6TiGJWd0KE63iIRWuYnvJ2brM1ORL/view?usp=drive_link'>
              <li>Terms of Use</li>
            </Link>
          </ul>
        </div>
        ...
        <div className='connect'>
          ...
          <ul>
            ...
            <li>
              <Link to='https://www.linkedin.com/company/sqladvisory/'>
                <svg
                  width='36'
                  height='36'
                  viewBox='0 0 36 36'
